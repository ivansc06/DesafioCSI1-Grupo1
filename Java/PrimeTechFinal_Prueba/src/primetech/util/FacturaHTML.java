...
public class FacturaHTML {
    ...
    private static String generarHTML(Venta venta, String empresa) {
        ...
        double ivaPorc = ConfiguracionApp.getIvaPorc();
        double subtotalSinIva = venta.getTotal() / (1 + ivaPorc);
        double iva = venta.getTotal() - subtotalSinIva;
        String empresaCif       = ConfiguracionApp.getEmpresaCif();
        String empresaDireccion = ConfiguracionApp.getEmpresaDireccion();
        String empresaEmail     = ConfiguracionApp.getEmpresaEmail();
        String empresaTelefono  = ConfiguracionApp.getEmpresaTelefono();
        int ivaPorc100 = (int) Math.round(ivaPorc * 100);
        ...
        sb.append("<!DOCTYPE html>\n<html lang='es'>\n<head>\n")
          ...
          .append(escape(empresa)).append("<br>CIF: ").append(escape(empresaCif))
          .append("<br>").append(escape(empresaDireccion))
          .append("<br>").append(escape(empresaEmail)).append("</p></div>\n")
        ...
        sb.append("  </tbody>\n</table>\n")
          ...
          .append("    <tr><td>IVA (").append(ivaPorc100).append("%)</td><td>").append(formatEuro(iva)).append("</td></tr>\n")
          ...
          .append("    <p style='margin-top:6px'>Para dudas contacte: ").append(escape(empresaEmail))
          .append(" | Tel: ").append(escape(empresaTelefono)).append("</p>\n")
          .append("  </div>\n")
          .append("</div>\n</body>\n</html>");
